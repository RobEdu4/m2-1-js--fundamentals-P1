...
function question5() {
  ...
  // 5.2. [[], 24, 'hello', true]
  console.log("5.2. Number of elements (object, number, string, boolean)", [
    "object",
    "number",
    "string",
    "boolean",
...
function question6() {
  ...
  // 6.1. let name = 'bob';
  console.log("6.1.", "string", "NaN");

  // 6.2. let age = 45;
  console.log("6.2.", "number", "45");

  // 6.3. let isMarried = false;
  console.log("6.3.", "boolean", "0");

  // 6.4. let kids = [{name: 'Morty', age: 3}, {name: 'Summer', age: 7}]
  console.log("6.4.", ["string", "number"], ["string", "number"]);
}

// Once you are done, type the following in the terminal to test your answer(s).
// yarn test exercise-1.test
